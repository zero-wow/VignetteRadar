...
local function BuildPanel()
    ...
    AddCheckbox(quests, "vignetteRadarFollowTrackedQuest", "Follow tracked quest", 258, -145, nil, 205)
    ...
    AddCheckbox(quests, "vignetteRadarEdgeCues", "Show off-range cues", 258, -262, nil, 205)
