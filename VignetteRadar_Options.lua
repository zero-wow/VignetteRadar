...
local function BuildPanel()
    ...
    AddCheckbox(quests, "vignetteRadarQuestColors", "Color each quest uniquely", 258, -177, nil, 205)
    AddLabel(quests, "QUEST AREAS", 24, -225)
    AddCheckbox(quests, "vignetteRadarQuestAreas", "Shade Blizzard quest areas", 18, -247, nil, 203)
    AddCheckbox(quests, "vignetteRadarEdgeCues", "Show off-range cues", 258, -247, nil, 205)
    AddCheckbox(quests, "vignetteRadarQuestHalos", "Approximate quest circles", 18, -282, nil, 203)
    AddLabel(quests, "Radius", 264, -280)
    AddChoice(quests, "vignetteRadarQuestHaloRadius", 10, "10", 308, -279, 39)
    AddChoice(quests, "vignetteRadarQuestHaloRadius", 20, "20", 356, -279, 39)
    AddChoice(quests, "vignetteRadarQuestHaloRadius", 40, "40", 404, -279, 39)
    AddChoice(quests, "vignetteRadarQuestHaloRadius", 80, "80", 452, -279, 39)
    ...
    AddButton(explore, "Saved presets, pins, route & journal", 24, -286, 472, function()
