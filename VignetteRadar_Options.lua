...
local function BuildPanel()
    ...
    AddLabel(explore, "Trail style", 250, -183)
    AddChoice(explore, "vignetteRadarTrailStyle", "dashes", "Dashes", 320, -177, 52)
    AddChoice(explore, "vignetteRadarTrailStyle", "ticks", "Ticks", 378, -177, 52)
    AddChoice(explore, "vignetteRadarTrailStyle", "dots", "Dots", 436, -177, 52)
