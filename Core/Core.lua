...
BINDING_NAME_VIGNETTERADAR_ROUTE_CLOSEST = "Auto Route: Closest Point"
...
function addon.GetSettings()
    ...
    if type(db.vignetteRadarHiddenMarkerTypes) ~= "table" then db.vignetteRadarHiddenMarkerTypes = {} end
